...
public class AvroUtils {
    ...
    public static byte[] convertFixToAvroByteArray(String rawMessage, FixVersion version) throws IOException {
    ...
    private static DataDictionary loadDataDictionary(String dictionaryPath) throws IOException, ConfigError {
    ...
    private static byte[] serializeGenericRecordToBytes(GenericRecord record, Schema schema) throws IOException {
