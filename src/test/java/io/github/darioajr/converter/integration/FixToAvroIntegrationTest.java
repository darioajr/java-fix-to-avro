...
class FixToAvroIntegrationTest {
    ...
    void testCustomSchemaConversionWithValidation() {
        ...
        String newOrderSingleCustom = "8=FIX.4.4|9=123|35=D|49=SenderCompID|56=TargetCompID|34=1|52=20231208-12:34:56|11=Order123|54=1|38=100|55=AAPL|44=50.00|10=242|";
        ...
        // mensagem FIX)
        assertDoesNotThrow(() -> {
            validator.validateFields(parsedFields, FixVersion.FIX_4_4, fieldCriteria); // Chamando a validação da mensagem FIX
